-- Add semantic similarity scoring using preference_embedding to get_top_picks_for_user
-- This enables personalized recommendations based on user's viewing/saving behavior
