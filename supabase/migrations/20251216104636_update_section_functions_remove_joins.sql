-- Update all section functions to remove JOINs and use denormalized columns
-- This migration removes JOINs with users, item_images, and categories tables
-- and uses the denormalized images, category, and user columns from items table

SET search_path = public;

-- ============================================================================
-- 1. Update fn_near_you
-- ============================================================================
...
COMMENT ON FUNCTION public.fn_near_you IS 'Returns items near the user based on location proximity, using denormalized data';

-- ============================================================================
-- 2. Update fn_fresh_finds
-- ============================================================================
...
COMMENT ON FUNCTION public.fn_fresh_finds IS 'Returns the freshest (newest) items sorted by creation date, using denormalized data';

-- ============================================================================
-- 3. Update fn_favourite_categories
-- ============================================================================
...
COMMENT ON FUNCTION public.fn_favourite_categories IS 'Returns items from the user''s favorite categories, using denormalized data';

-- ============================================================================
-- 4. Update fn_best_deals
-- ============================================================================
...
BEGIN
  ...
  SELECT
    ...
    md.category_id,
    md.user_id,
    COALESCE(md.images, '[]'::jsonb) AS images,
    md.category,
    md."user",
    md.distance_km
...
COMMENT ON FUNCTION public.fn_best_deals IS 'Returns items matching user''s recently added items, using denormalized data';

-- ============================================================================
-- 5. Update fn_top_picks_for_you
-- ============================================================================
...
BEGIN
  ...
  SELECT
    ...
    vs.category_id,
    vs.user_id,
    COALESCE(vs.images, '[]'::jsonb) AS images,
    vs.category,
    vs."user",
    vs.distance_km
...
COMMENT ON FUNCTION public.fn_top_picks_for_you IS 'Returns AI-powered item recommendations, using denormalized data';

-- ============================================================================
-- 6. Update fn_trending_categories
-- ============================================================================
...
BEGIN
  ...
  SELECT
    il.category_id,
    (il.category->>'title_en')::text AS category_title_en,
    (il.category->>'title_ka')::text AS category_title_ka,
    il.category_rank,
    il.item_count,
    il.id,
    il.title,
    ...
    il.updated_at,
    il.user_id,
    COALESCE(il.images, '[]'::jsonb) AS images,
    il.category,
    il."user",
    il.distance_km
...
COMMENT ON FUNCTION public.fn_trending_categories IS 'Returns trending categories with items, using denormalized data';

-- ============================================================================
-- 7. Update fn_budget_picks
-- ============================================================================
...
COMMENT ON FUNCTION public.fn_budget_picks IS 'Returns budget-friendly items, using denormalized data';

-- ============================================================================
-- 8. Update fn_mostly_viewed
-- ============================================================================
...
COMMENT ON FUNCTION public.fn_mostly_viewed IS 'Returns the most viewed items sorted by view count, using denormalized data';
