-- Remove NOT NULL constraint from username field
-- Allow username to be NULL so users can set it during onboarding

ALTER TABLE users
ALTER COLUMN username DROP NOT NULL;

-- Update the trigger to not auto-generate username
...
BEGIN
  ...
  -- Only set username if explicitly provided in metadata, otherwise leave it NULL
