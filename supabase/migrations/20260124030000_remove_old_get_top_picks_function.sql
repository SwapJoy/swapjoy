-- Remove old get_top_picks_for_user function (5 parameters, no pagination)
-- Keep only the new version with p_offset parameter (6 parameters)

-- Drop the old function signature (5 parameters, no p_offset)
...
-- Ensure the new function with pagination exists (6 parameters, with p_offset)
-- This will recreate it if it doesn't exist, or do nothing if it already exists
