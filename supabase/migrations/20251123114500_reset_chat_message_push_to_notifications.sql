...
-- Reset chat message trigger to create a notification row,
-- so the existing `push` Edge Function (notifications webhook)
-- is reused for chat messages as well.
...
begin
  ...
  -- which already computes the consolidated badge (notifications + unread chats).
