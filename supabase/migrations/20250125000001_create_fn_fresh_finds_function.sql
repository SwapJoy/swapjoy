-- Create function to get fresh finds (newest items)
-- This function returns recently added items sorted by creation date
...
COMMENT ON FUNCTION public.fn_fresh_finds IS 'Returns the freshest (newest) items sorted by creation date, with optional distance calculation';
