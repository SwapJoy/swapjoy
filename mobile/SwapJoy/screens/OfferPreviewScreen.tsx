...
const styles = StyleSheet.create({
  ...
  itemCard: { backgroundColor: '#161200', marginRight: 12, borderRadius: 10, overflow: 'hidden', width: 220 },
  ...
  infoBox: { backgroundColor: '#161200', marginHorizontal: 16, marginVertical: 12, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#eee' },
  ...
  submitText: { color: '#161200', fontSize: 16, fontWeight: '700' },
});
